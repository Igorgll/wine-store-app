  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          style={styles.image}
          source={{uri:"https://imgur.com/jiljBU1.png"}}
        />
      </View>
      <View>
        <Text
        ...
        >
          Diversidade de sabores à sua escolha
        </Text>
        <Text
          style={{
            color: "#000000",
        ...
        >
          Explore o mundo do vinho em um só lugar
        </Text>
      </View>
      <View style={{ flexDirection: "row-reverse", height: 130, alignItems: "center", justifyContent: "space-between" }}>
        ...
        <Image
          style={{ width: 91, height: 6, borderRadius: 6 }}
          source={{uri:"https://imgur.com/KjHgW1y.png"}}
        />
      </View>
      <StatusBar style="auto" />
    </View>
